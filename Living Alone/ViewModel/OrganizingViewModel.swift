...
class OrganizingViewModel: ObservableObject {
    ...
    init() { // inserir dados abaixo!
        ...
        // organização
        organizingTipsList.append(dicasGerais)
        organizingTipsList.append(ganchosPrateleiras)
        organizingTipsList.append(argolasChuveiro)
        organizingTipsList.append(mesaTenis)
    }
}
